 ...
 * Author: David
 *
 * Created on October 24, 2024, 5:53 PM
 */
...
{
	CLCD_RS = control_bit;
	CLCD_PORT = byte;               //data port rd0 - rd7

	/* Should be atleast 200ns */
	CLCD_EN = HI;                   //based on this it it wll generate clock pulse
	CLCD_EN = LO;

	PORT_DIR = INPUT;               //rd7 act as i/p
	CLCD_RW = HI;                   // in this we are going to do read operation
